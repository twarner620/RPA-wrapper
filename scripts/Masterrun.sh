...
ref='/path/to/reference_genome.fa'          # Fasta file for the reference genome
range='/path/to/reference_genome.bed'       # BED file of ranges in the nucleus
bed='beds/'                                 # Folder of bed files with extension .bed
order='config/order'                        # Order file for sample plotting sequence
outdir='output_directory'                   # Output directory (change per run to keep results separate)
